    ...
    return {
      items: [
        ...
        },
        {
          title: '娱乐',
          url:
            'http://service.picasso.adesk.com/videoimg/v1/videowp/category/59b25abbe7bce76bc834198a',
          params: { limit: 30, skip: 0, order: 'new' },
        },
        {
          title: '最新',
          url: 'http://service.picasso.adesk.com/videoimg/v1/videowp/videowp',
          params: { limit: 30, skip: 0, order: 'new' },
        },
        {
          title: '热门',
        ...
        {
          title: '分类',
          url: 'http://service.picasso.adesk.com/videoimg/v1/videowp/category',
          params: {},
        },
      ],
      current: 0,
